...
!function(t, e) {
  function n() {
    var n = '-',
        ...
        o = t.navigator,
        s = this._getViewport();
    this.screen = r ? r.width + 'x' + r.height : n, this.viewport = s.width +
        'x' + s.height, this.charset = i(e.characterSet ?
        e.characterSet :
        e.charset ?
            e.charset :
            n), this.language = (o && o.language ?
        o.language :
        o && o.browserLanguage ?
            o.browserLanguage :
            n).toLowerCase(), this.javaEnabled = o && o.javaEnabled() ?
        1 :
        0, this.isFirstVisit = !1, this.setCookie();
  }
  ...
  function r(t) {
    ...
    }, t || {}), this._client = new n, this._beacon = new i(
        this._config.beacon), this._queue = [], this._timer = null, this._app = null, this._tags = {}, this.visitorCode = a.random();
  }
  ...
  var o = Object.prototype.hasOwnProperty,
      a = {
        hash: function(t) {
          var e, n = 1,
              i = 0;
          if (t)
            for (n = 0, e = t.length - 1; e >= 0; e--) i = t.charCodeAt(
                e), n = (n << 6 & 268435455) + i + (i << 14), i = 266338304 &
                n, n = 0 !== i ? n ^ i >> 21 : n;
          return n;
        },
        ...
        whitelistify: function(t, e) {
          ...
          return a.keyPaths(t, function(t, e) {
            if (-1 !== i.indexOf('|' + t.join('.') + '|'))
              for (var n = r, o = 0; o < t.length; o++) n[t[o]] ||
              (n[t[o]] = {}), o === t.length - 1 && (n[t[o]] = e), n = n[t[o]];
          }), r;
        },
        random: function() {
        ...
        stringify: function(t) {
          if ('undefined' != typeof JSON &&
              JSON.stringify) return JSON.stringify(t);
          var e = typeof t;
          switch (e) {
            case 'string':
              return '"' + t + '"';
            ...
            case 'object':
              ...
              for (var r in t)
                if (o.call(t, r)) {
                  var s = '' + r,
                      c = a.stringify(t[r]);
                  c.length && (n ? i += ',' : n = !0, i += t instanceof Array ?
                      c :
                      '"' + s + '":' + c);
                }
        ...
        debug: function(t, e) {
          ...
          (e && console.warn ? console.warn(t) : console.log(t));
        },
        encode: function(t, e) {
        ...
        decode: function(t, e) {
          var n;
          if (t = t.split('+').join(' '), decodeURIComponent instanceof
              Function) try {
        ...
        onunload: function(t) {
          a.addEventListener('unload', t, !1), a.addEventListener(
              'beforeunload', t, !1);
        },
        now: function() {
        ...
        ajax: function(e) {
          if ('file:' !== t.location.protocol) {
            ...
            if (t.XDomainRequest) try {
              n = new t.XMLHttpRequest, n.open(i.method, i.url), n.send(
                  a.stringify(i.data));
            } catch (r) {
            } else {
              if (!t.XMLHttpRequest) return;
              if (n = new t.XMLHttpRequest, 'withCredentials' in n) try {
                n.open(i.method, i.url, i.async), n.setRequestHeader(
                    'Content-type', 'application/json'), n.send(
                    a.stringify(i.data));
              } catch (r) {
              }
            }
      ...
      s = {
        ...
        trigger: function(t) {
          ...
          if (this.queue[t])
            for (e = 0; e < this.queue[t].length; e++) this.queue[t][e].apply(
                this, n);
        },
      },
      c = {
        get: function(t) {
          for (var n = e.cookie, i = t +
              '=', r = i.length, o = n.length, a = 0; o > a;) {
            var s = a + r;
        ...
        set: function(t, n, i, r, o, a) {
          o = o ? o : this._getDomain(), e.cookie = t + '=' +
              encodeURIComponent(n) + (i ? '; expires=' + i : '') +
              (r ? '; path=' + r : '; path=/') + (o ? '; domain=' + o : '') +
              (a ? '; secure' : '');
        },
        getExpire: function(t, e, n) {
          ...
          'number' == typeof e ?
              (i.setDate(i.getDate() +
                  parseInt(t, 10)), i.setHours(i.getHours() +
                  parseInt(e, 10)), i.setMinutes(i.getMinutes() +
                  parseInt(n, 10)), i.toGMTString()) :
              void 0;
        },
        _getValue: function(t) {
          var n = e.cookie,
              i = n.indexOf(';', t);
          return -1 === i && (i = n.length), decodeURIComponent(
              n.substring(t, i));
        },
        _getDomain: function() {
          var t = e.domain;
          return 'localhost' === t ?
              '' :
              ('undefined' != typeof M && M.DOMAIN_HOST &&
              (t = '.' + M.DOMAIN_HOST), 'www.' === t.substring(0, 4) &&
              (t = t.substring(4)), t);
        },
      },
      u = '__mta';
  n.prototype = {
    setCookie: function() {
      var t = c.get(u),
          ...
          n = a.now();
      if (t) t = t.split('.'), t[2] = t[3], t[3] = n, t[4] = parseInt(t[4],
          10) + 1, c.set(u, t.join('.'), e), this.uuid = t[0];
      else {
        var i = this._hashInfo(),
            ...
            s = n,
            d = 1;
        t = [i, r, o, s, d].join('.'), c.set(u, t,
            e), this.isFirstVisit = !0, this.uuid = i;
      }
    },
    getInfo: function() {
      return {
    ...
    _hashInfo: function() {
      var n = t.navigator,
          i = t.history.length;
      n = n.appName + n.version + this.language + n.platform + n.userAgent +
          this.javaEnabled + this.screen + (e.cookie ? e.cookie : '') +
    ...
    send: function(t) {
      ...
      e.length && ((this.url + '?' + e).length <= i.MAX_URL_LENGTH ?
          this._sendByScript(e) :
          this.post(t));
    },
    post: function(t) {
      a.ajax({
  ...
  r.VERSION = '0.6.1', r.Plugins = {}, r.addPlugin = function(t, e) {
    ...
    push: function() {
      for (var t = Array.prototype.slice, e = 0, n = 0, i = arguments.length; i >
      n; n++) try {
        var r = arguments[n];
    ...
    create: function(t, e) {
      this._app = t, this._config = a.merge(this._config, e ||
          {}), this._config.sampleRate = 5, this.send('resources');
    },
    config: function(t, e) {
    ...
    tag: function(t, e) {
      'string' == typeof t && t.length && ('undefined' != typeof e ?
          this._tags[t] = e :
          'undefined' != typeof this._tags[t] && delete this._tags[t]);
    },
    send: function(e, n, i, o) {
      if (e) {
        ...
        var c = this;
        this._timer && (t.clearTimeout(
            this._timer), this._timer = null), this._timer = t.setTimeout(
            function() {
              c._send.call(c);
            }, d);
      }
      ...
      if (this._isSampleHit()) {
        var e = a.merge,
            ...
            r = {
              app: this._app,
              type: 'combo',
              url: t.location.protocol + '//' + t.location.hostname +
              t.location.pathname,
              autotags: this._config.autotags,
            };
        if (r = e(r, i), this._queue.length) {
          if (n) 1 === this._queue.length ?
              (r = e(r, this._queue[0]), s.trigger('data',
                  r), this._beacon.send(r)) :
              (r.data = this._queue, s.trigger('data', r), this._beacon.send(
                  r));
          else
            for (var o = 0, c = this._queue.length; c > o; o++) r = e(r,
                this._queue[o]), s.trigger('data', r), this._beacon.send(r);
          this._queue = [];
        }
      }
    },
    ...
    data: function() {
      ...
      var n = t,
          i = n.performance || n.mozPerformance || n.msPerformance ||
              n.webkitPerformance;
      if (i) {
        var r = i.timing,
            o = {
        ...
        if ('object' == typeof M && M.subresources && M.subresources.names &&
            'undefined' != typeof t.SubResoucesTiming) {
          var a = M.subresources.lastImage || '',
              s = M.subresources.firstImage || '',
              c = new t.SubResoucesTiming(M.subresources.names, a, s);
          c.length && 'fsImg' === c[c.length - 1].id &&
          (o.atf = c[c.length - 1].start, o.c_atf = c[c.length - 1].start -
              e(r.responseStart, r.navigationStart));
        }
        if (r.msFirstPaint && 'number' == typeof r.msFirstPaint &&
            (o.firstPaint = e(r.msFirstPaint, r.navigationStart)), n.chrome &&
            n.chrome.loadTimes) {
          var u = n.chrome.loadTimes();
          o.firstPaint = Math.round(1e3 * e(u.firstPaintTime, u.startLoadTime));
        }
        return ('number' != typeof o.firstPaint || o.firstPaint < 0) &&
        (o.firstPaint = void 0), 'undefined' != typeof M && M.TimeTracker &&
        M.TimeTracker.fst &&
        (o.firstScreen = e(M.TimeTracker.fst, r.navigationStart)), o;
      }
    },
  }),
      function() {
        ...
        r.addPlugin('resources', {
          ...
          data: function() {
            ...
            if (i && i.getEntriesByType) {
              for (var r = t.performance.getEntriesByType(
                  'resource'), o = [], a = 0; a < r.length; a++) {
                var s = r[a],
                    c = {
                      load: parseInt(s.duration, 10),
                    };
                e(c, 'redirect', s.redirectEnd, s.redirectStart), e(c,
                    'appcache', s.domainLookupStart, s.fetchStart), e(c, 'dns',
                    s.domainLookupEnd, s.domainLookupStart), e(c, 'network',
                    s.connectEnd, s.connectStart), e(c, 'send', s.requestStart,
                    s.connectEnd), e(c, 'ttfb', s.responseStart,
                    s.requestStart), e(c, 'receive', s.responseEnd,
                    s.responseStart);
                var u = s.name + '?',
                    d = {
                      tags: {
    ...
    if (t.MeituanAnalyticsObject) {
      ...
      for (var n = 0; n < e.length; n++) !function(e) {
        ...
        if ('function' == typeof n &&
            !(n.q && n.q.isInitialized && n.q.isInitialized())) {
